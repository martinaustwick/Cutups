...
void setup()
{
    ...
    //folderPath = "/Users/martin/Music/iTunes/iTunes Media/Podcasts/Getting Better Acquainted/";
    //folderPath = "/Users/mza/Music/iTunes/iTunes Media/Podcasts/99% Invisible/";
    //noLoop();
    //selectFolder("Select your audio folder (must contain only mp3s)", "folderSelected");
...
void randomFile()
{
    ...
    println(name);   
    //interview = new SoundFile(this, folderPath + name);
